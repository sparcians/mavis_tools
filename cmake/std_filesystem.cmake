...
execute_process(COMMAND bash "-c" "${CMAKE_CXX_COMPILER} ${FILESYSTEM_CHECK_FLAGS} -E ${CMAKE_SOURCE_DIR}/include/filesystem.hpp | grep \"namespace fs\" | grep -qv experimental"
